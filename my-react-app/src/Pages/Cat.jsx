...
const categories = {
  ...
  'fashion': [
    ...
    { name: 'Slippers and Heels', description: 'Stylish footwear', imageSrc: high , link:'slippers-heels'},
    { name: 'Skirts', description: 'Stylish footwear', imageSrc: skirts , link:'skirts'},
  ],
};
