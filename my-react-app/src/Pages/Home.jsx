...
export default function Home() {
  return (
    ...
    <div className="relative overflow-hidden bg-white">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
              ...
              <div>
                <div className="mt-10">
                  ...
                  <a
                    href="#"
                    className="inline-block rounded-md border border-transparent bg-green-500 px-8 py-3 text-center font-medium text-black hover:bg-green-600 font-bold"
                  >
                    Booking Now
                  </a>
                </div>
      ...
      <Container className="text-center font-bold my-5">
        <Row>
          <Col>
            <h1>
          ...
          <Col>
            ...
            <p>Drivers working with us</p>
          </Col>
          <Col>
            <h2>
              <CountUp start={0} end={46000} duration={2.5} separator="," /> +
            </h2>
